<?php
// admin/users.php
// User Management Page with DataTables, Agency Assignment, and Auto-Assign Control
session_start();
...
$stmtUsers = $pdo->query("
    SELECT u.id, u.username, u.email, u.role, u.agency_id, u.auto_assign_tickets, u.auth_provider, u.two_factor_enabled, u.created_at,
                            ...
                            <?php foreach ($users as $u): ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form method="POST" action="users.php" class="d-inline-flex align-items-center gap-2">
