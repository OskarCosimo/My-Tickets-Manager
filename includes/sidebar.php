...
// Dynamic Sidebar template file with structured role-based sections
...
<aside id="sidebar-wrapper" class="bg-dark text-white border-end">
    <div class="list-group list-group-flush py-3">
        ...
        <div class="px-3 text-uppercase text-muted small fw-bold mb-2"><?php echo __('general', 'General'); ?></div>
        ...
        <?php if ($isStaff): ?>
            ...
            <div class="px-3 text-uppercase text-muted small fw-bold mb-2"><?php echo __('staff_workspace', 'Staff Workspace'); ?></div>
            ...
            <?php if ($isAgency): ?>
                ...
                <hr class="text-secondary my-2">
                <div class="px-3 text-uppercase text-muted small fw-bold mb-2"><?php echo __('agency_management', 'Agency Management'); ?></div>
                
                <a href="/admin/users.php?filter=agents" class="list-group-item list-group-item-action bg-transparent text-white border-0" title="<?php echo __('my_agents', 'My Agents'); ?>">
            ...
            <?php if ($isAdmin): ?>
                ...
                <hr class="text-secondary my-2">
                <div class="px-3 text-uppercase text-muted small fw-bold mb-2"><?php echo __('system_administration', 'System Administration'); ?></div>
                
                <a href="/admin/users.php" class="list-group-item list-group-item-action bg-transparent text-white border-0" title="<?php echo __('all_users', 'All Users'); ?>">
                    <i class="fa-solid fa-users-gear me-2"></i><span class="link-text"><?php echo __('all_users', 'All Users'); ?></span>
                </a>
